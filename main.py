...
dropped_origins = base_df.Origin_Category[base_df.Origin_Category < 1].count()
dropped_destinations = base_df.Destination_Category[base_df.Destination_Category < 1].count()
base_df = base_df.drop(base_df[base_df.Origin_Category < 1].index)
base_df = base_df.drop(base_df[base_df.Destination_Category < 1].index)
#base_df.info()
...
jny_Category = np.maximum(base_df.Origin_Category, base_df.Destination_Category)
