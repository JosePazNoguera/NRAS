...
for station in upgrade_list.TLC:
    scenario_1['Origin_TLC' == station].Origin_Category = upgrade_list['TLC' == station].New_Category
    scenario_1['Origin_TLC' == station].origin_score = scenario_1.Origin_Category.map(my_dict)
...
print(scenario_1['Origin_TLC' == "HUR"])
